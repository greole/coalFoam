...
#include "FletcherDevolatilisation.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::FletcherDevolatilisation<CloudType>::
...
template<class CloudType>
void Foam::FletcherDevolatilisation<CloudType>::calculate
(
    const scalar dt,
    const scalar age,
    const scalar mass0,
...
) const
{
    ...
    forAll(volatileData_, i)
    {
        ...
        // const scalar Y = volatileData_[i].Y();
        // const scalarField c = volatileData_[i].c();
        //
        // // Kinetic rate
